     ...
     $("#add-quiz-question").on('click', function(){
         ...
         $(".quiz-question").append(''+
                           ...
                           '<div class="col-lg-12">'+
                             ...
                             '<button type="button" data-toggle="collapse" data-target="#collapse'+ck+'"class="collapsebutton mr-2 btn btn-info" data-id="plus" aria-expanded="true" aria-controls="collapse'+ck+'"><i class="fas fa-minus"></i></button>'+
                        ...
                        '<div class="row mt-5">'+
                          '<div class="col-lg-12">'+
                            ...
                            '<div class="btn d-flex justify-content-between bg-light">'+
                             ...
                             '<span class="btn btn-danger btn-sm">'+
                             '<i class="fas fa-trash remove_quiz_result" data-qrid="'+qr+'"></i>'+
                             '</span>'+
                             '</div>'+
                             '</div>'+
                             '</div>'+
