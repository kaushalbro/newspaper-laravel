...
<div class="content-area">
    ...
    <div class="row mb-3">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{route('user.shortlist.create')}}" class="add-post-area">
                    <div class="icon">
            ...
            <div class="col-lg-4 col-md-6">
               <a href="{{ route('user.tquiz.create') }}" class="add-post-area">
                    <div class="icon">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('user.pquiz.create') }}" class="add-post-area">
                    <div class="icon">
