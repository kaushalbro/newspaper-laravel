...
<div class="content-area">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('user.post.index') }}">{{ __('Audio') }}</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <form id="geniusformdata2" action="{{ route('user.audio.store')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <select name="language_id" id="article_language_id">
                                                <option value="">@lang('Please Select a Language')</option>
