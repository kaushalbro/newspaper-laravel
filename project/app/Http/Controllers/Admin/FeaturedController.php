...
class FeaturedController extends Controller
{
    ...
    public function datatables(Request $request){
        ...
        return Datatables::of($datas)
                            ...
                            ->rawColumns(['image_big','category_id','language_id','post_type','admin_id','description','action','checkbox'])
    ...
    public function categoryFilter($id){
        ...
        $output = '<option data-href="'.route('feature.datatables').'?category=&lang='.$id.'">All</option>';
        foreach($datas as $data){
            $output .= '<option data-href="'.route('feature.datatables').'?category='.$data->id.'">'.$data->title.'</option>';
        }
        return $output;
    }
}
